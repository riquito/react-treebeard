...
var Header = function Header(props) {
    ...
    return _react2['default'].createElement(
        'div',
        { style: style.base, className: 'treebeard-header', onClick: props.onClick },
        _react2['default'].createElement(
            'div',
            { style: style.title },
            props.node.name
...
var Container = (function (_React$Component) {
    ...
    _createClass(Container, [{
        ...
        value: function renderToggleDecorator() {
            ...
            return _react2['default'].createElement(decorators.Toggle, { style: style.toggle || {}, onClick: this.props.onToggle, node: this.props.node });
        }
    }]);
